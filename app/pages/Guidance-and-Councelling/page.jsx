          ...
          <div className="relative z-10 p-6 sm:p-10">
            <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
              ...
              <div className="flex w-fit items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1.5">
                ...
                <span className="text-[9px] font-bold uppercase tracking-wider text-white/65">Support Center</span>
              </div>
            </div>
            ...
            <div className="mt-8 max-w-4xl space-y-5">
              <div>
                <h1 className="text-3xl font-black leading-tight tracking-tight text-white sm:text-4xl md:text-5xl lg:text-6xl">
                  Guidance &
                  <span className="block text-emerald-200 sm:inline"> Counselling</span>
                </h1>
                ...
                <p className="max-w-2xl text-sm font-medium leading-relaxed text-white sm:text-base">
                  Professional support hub for student well-being, mentorship, spiritual care, and academic guidance. Browse our counselling sessions and meet our dedicated support team.
                </p>
              </div>
