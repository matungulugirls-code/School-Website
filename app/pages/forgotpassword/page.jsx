      ...
      <div className="relative mx-auto grid min-h-screen max-w-7xl gap-8 px-4 py-6 sm:px-6 lg:grid-cols-[0.95fr_1.05fr] lg:items-center lg:px-8">
        <section className="order-2 space-y-6 lg:order-1">
          ...
          <div className="grid gap-4 sm:grid-cols-3 lg:grid-cols-1 xl:grid-cols-3">
            {infoCards.map((card) => (
              <div
                key={card.title}
                className="rounded-[1.6rem] border border-slate-200 bg-white p-5 shadow-[0_18px_55px_-45px_rgba(15,23,42,0.28)]"
              >
        ...
        <section className="order-1 lg:order-2">
          <div className="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-[0_22px_70px_-52px_rgba(15,23,42,0.35)] sm:p-8">
            ...
            {emailSent && (
              <div className="mt-5 rounded-[1.4rem] border border-emerald-200 bg-emerald-50 p-4 text-sm font-semibold text-emerald-900">
            ...
            <div className="mt-6 border-t border-slate-200 pt-5 text-xs font-bold uppercase tracking-[0.22em] text-slate-500">
