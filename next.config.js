...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/kcse', destination: '/pages/KCSE-Performance', permanent: true },
      { source: '/kcse-performance', destination: '/pages/KCSE-Performance', permanent: true },
      { source: '/kcse-perfomance', destination: '/pages/KCSE-Performance', permanent: true },
      { source: '/kcse-results', destination: '/pages/KCSE-Performance', permanent: true },
      { source: '/page/KCSE-Performance', destination: '/pages/KCSE-Performance', permanent: true },
      { source: '/page/KCSE-Perfomance', destination: '/pages/KCSE-Performance', permanent: true },
      { source: '/page/kcse-performance', destination: '/pages/KCSE-Performance', permanent: true },
      { source: '/page/kcse-perfomance', destination: '/pages/KCSE-Performance', permanent: true },
      { source: '/pages/KCSE-Perfomance', destination: '/pages/KCSE-Performance', permanent: true },
      { source: '/pages/kcse-performance', destination: '/pages/KCSE-Performance', permanent: true },
      { source: '/pages/kcse-perfomance', destination: '/pages/KCSE-Performance', permanent: true },
      { source: '/pages/kcse-results', destination: '/pages/KCSE-Performance', permanent: true },
